...
contract CLSlot0Test is Test {
        ...
        pure
    {
        ...
        CLSlot0 _slot0 = CLSlot0.wrap(bytes32(0)).setSqrtPriceX96(sqrtPriceX96).setTick(tick)
            .setProtocolFee(protocolFee).setLpFee(lpFee);
        ...
        _slot0 = CLSlot0.wrap(bytes32(0)).setLpFee(lpFee).setProtocolFee(protocolFee).setTick(tick)
